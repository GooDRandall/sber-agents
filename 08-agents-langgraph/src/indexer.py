...
def create_embeddings():
    ...
    if provider == "openai":
        ...
        logger.info(f"Creating Ollama embeddings: {config.EMBEDDING_MODEL} at {config.OLLAMA_BASE_URL}")
        ...
        raise ValueError(f"Unknown embedding provider: {provider}. Use 'openai', 'huggingface', or 'ollama'")
