...
#### Ollama (локальные embeddings)

1. Установите [Ollama](https://ollama.ai/)
2. Убедитесь, что Ollama запущен (обычно запускается автоматически)
3. Установите модель embeddings:
   ```bash
   ollama pull aroxima/multilingual-e5-large-instruct:latest
   ```
4. Проверьте, что модель установлена:
   ```bash
   ollama list
   ```
...
**Вариант 3: Ollama (локальные embeddings)**
