...
class Config:
    ...
    EMBEDDING_PROVIDER = os.getenv("EMBEDDING_PROVIDER", "openai")  # 'openai', 'huggingface', или 'ollama'
    ...
    RAGAS_LLM_PROVIDER = os.getenv("RAGAS_LLM_PROVIDER", "openai")  # 'openai' или 'ollama'
    RAGAS_EMBEDDING_MODEL = os.getenv("RAGAS_EMBEDDING_MODEL", "text-embedding-3-large")
    RAGAS_EMBEDDING_PROVIDER = os.getenv("RAGAS_EMBEDDING_PROVIDER", "openai")  # 'openai', 'huggingface', или 'ollama'
